...
var file_proto_capper_capper_proto_rawDesc = []byte{
	...
	,
...
var file_proto_capper_capper_proto_goTypes = []interface{}{
	...
	(*CaptureResponse)(nil),      // 1: capper.CaptureResponse
	(*CaptureInterface)(nil),     // 2: capper.CaptureInterface
...
var file_proto_capper_capper_proto_depIdxs = []int32{
	...
	7, // 1: capper.CaptureRequest.k8s_pod_filter:type_name -> capper.Pod
	2, // 2: capper.CaptureResponse.interface:type_name -> capper.CaptureInterface
	5, // 3: capper.NodeMetadataResponse.updates:type_name -> capper.NodeMetadataUpdate
	6, // 4: capper.NodeMetadataUpdate.pod_updates:type_name -> capper.PodMetadataUpdate
	7, // 5: capper.PodMetadataUpdate.added_pods:type_name -> capper.Pod
	7, // 6: capper.PodMetadataUpdate.removed_pods:type_name -> capper.Pod
	0, // 7: capper.Capper.Capture:input_type -> capper.CaptureRequest
	3, // 8: capper.Capper.NodeMetadata:input_type -> capper.NodeMetadataRequest
	1, // 9: capper.Capper.Capture:output_type -> capper.CaptureResponse
	4, // 10: capper.Capper.NodeMetadata:output_type -> capper.NodeMetadataResponse
